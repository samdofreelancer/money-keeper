package com.personal.money.management.service.category.interfaces.api;

import com.personal.money.management.service.category.application.CategoryService;
...
class CategoryControllerTest {
    ...
    void deleteCategory_shouldReturnNotFound() throws Exception {
        ...
        doThrow(new com.personal.money.management.service.category.application.exception.CategoryNotFoundException(categoryId))
    ...
    void deleteCategory_shouldReturnConflictIfCategoryHasChildren() throws Exception {
        ...
        doThrow(new com.personal.money.management.service.category.application.exception.CategoryHasChildException(categoryId))
                .when(categoryService).deleteCategory(categoryId);
    ...
    void updateCategory_shouldReturnConflictIfCyclicDependency() throws Exception {
        ...
        doThrow(new com.personal.money.management.service.category.application.exception.CategoryCyclicDependencyException("Cyclic dependency detected"))
    ...
    void updateCategory_shouldReturnConflictIfCategoryConflictException() throws Exception {
        ...
        doThrow(new com.personal.money.management.service.category.application.exception.CategoryConflictException("Concurrent modification"))
                .when(categoryService).updateCategory(anyLong(), anyString(), anyString(), any(), any());
