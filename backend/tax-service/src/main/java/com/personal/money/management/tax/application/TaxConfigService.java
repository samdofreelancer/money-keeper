...
import com.personal.money.management.tax.domain.service.DeductionBracketRepository;
import com.personal.money.management.tax.domain.service.TaxBracketDetailRepository;
import com.personal.money.management.tax.domain.service.TaxBracketRepository;
import com.personal.money.management.tax.domain.service.WageZoneRepository;
...
import com.personal.money.management.tax.interfaces.TaxConfigResponse;
...
public class TaxConfigService {
     ...
     */
    private List<TaxConfigResponse.TaxBracketOption> getTaxBrackets() {
        List<TaxConfigResponse.TaxBracketOption> options = new ArrayList<>();
        List<TaxBracketEntity> entities = taxBracketRepository.findAllOrderByEffectiveDate();
        
        for (TaxBracketEntity entity : entities) {
            List<TaxConfigResponse.TaxBracketDetail> details = new ArrayList<>();
            if (entity.getDetails() != null) {
                entity.getDetails().forEach(detail -> {
                    details.add(new TaxConfigResponse.TaxBracketDetail(
                        detail.getMinIncome(),
                        detail.getMaxIncome(),
            ...
            TaxConfigResponse.TaxBracketOption option = new TaxConfigResponse.TaxBracketOption(
                entity.getValue(),
                entity.getLabel(),
     ...
     */
    private List<TaxConfigResponse.DeductionBracketOption> getDeductionBrackets() {
        List<TaxConfigResponse.DeductionBracketOption> options = new ArrayList<>();
        List<DeductionBracketEntity> entities = deductionBracketRepository.findAll();
        
        for (DeductionBracketEntity entity : entities) {
            TaxConfigResponse.DeductionBracketOption option = new TaxConfigResponse.DeductionBracketOption(
                entity.getValue(),
                entity.getLabel(),
     ...
     */
    private List<TaxConfigResponse.WageZoneOption> getWageZones() {
        List<TaxConfigResponse.WageZoneOption> options = new ArrayList<>();
        List<WageZoneEntity> entities = wageZoneRepository.findAll();
        
        for (WageZoneEntity entity : entities) {
            TaxConfigResponse.WageZoneOption option = new TaxConfigResponse.WageZoneOption(
                entity.getValue(),
                entity.getLabel(),
     ...
     */
    public TaxConfigResponse.TaxBracketOption getTaxBracketByValue(String value) {
        Optional<TaxBracketEntity> optionalBracket = taxBracketRepository.findByValue(value);
        if (!optionalBracket.isPresent()) {
            return null;
        }
        ...
        return new TaxConfigResponse.TaxBracketOption(
            entity.getValue(),
            entity.getLabel(),
            entity.getEffectiveDate().toString(),
            details
