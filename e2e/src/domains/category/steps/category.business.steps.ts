    ...
    if (this.categoryDomain) {
      try {
        const invalidCategoryData = {
          name: { value: invalidChars } as CategoryName,
          icon: { value: "Grid" } as CategoryIcon,
...
When(
  ...
  async function (
    ...
    const categoryData = {
      name: { value: uniqueName } as CategoryName,
      icon: { value: "Grid" } as CategoryIcon,
...
When(
  ...
  async function (this: CustomWorld, icon: string) {
    if (this.pendingCategoryData && this.categoryDomain) {
      this.pendingCategoryData.icon = { value: icon } as CategoryIcon;

      // Now execute the creation
      await this.categoryDomain.createCategory(this.pendingCategoryData);
      this.trackCreatedCategory(null, this.pendingCategoryData.name.value);
  ...
  async function (this: CustomWorld, newName: string) {
    ...
    if (originalUniqueName && this.categoryDomain) {
      const newCategoryData = {
        name: { value: uniqueName } as CategoryName,
        icon: { value: "Food" } as CategoryIcon,
        type: "EXPENSE" as CategoryType,
        parentCategory: "" as ParentCategory,
      };
...
Given(
  ...
  async function (this: CustomWorld) {
    if (this.categoryDomain) {
      await this.categoryDomain.searchCategories({ name: { value: "Test" } });
...
When(
  ...
  async function (this: CustomWorld, originalName: string, newName: string) {
    ...
    if (this.categoryDomain) {
      try {
        const newCategoryData = {
          name: { value: newUniqueName } as CategoryName,
          icon: { value: "Grid" } as CategoryIcon,
          type: "EXPENSE" as CategoryType,
          parentCategory: "" as ParentCategory,
        };
...
When(
  ...
  async function (this: CustomWorld, maxLength: number) {
    ...
    if (this.categoryDomain) {
      try {
        const invalidCategoryData = {
          name: { value: longName } as CategoryName,
          icon: { value: "Grid" } as CategoryIcon,
          type: "EXPENSE" as CategoryType,
          parentCategory: "" as ParentCategory,
        };
...
When(
  ...
  async function (this: CustomWorld) {
    ...
    if (this.categoryDomain) {
      try {
        const invalidCategoryData = {
          name: { value: invalidName } as CategoryName,
          icon: { value: "Grid" } as CategoryIcon,
          type: "EXPENSE" as CategoryType,
          parentCategory: "" as ParentCategory,
        };
...
When("I clear the search filter", async function (this: CustomWorld) {
  if (this.categoryDomain) {
    await this.categoryDomain.searchCategories({ name: { value: "" } });
