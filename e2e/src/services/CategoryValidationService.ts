import { CategoryFormData, CategoryValidationResult } from "../types/CategoryTypes";
...
export class CategoryValidationService {
   ...
   */
  validateCategoryData(categoryData: CategoryFormData): CategoryValidationResult {
    const errors: string[] = [];
   ...
   */
  validateCategoryNameUniqueness(categoryName: string, existingCategories: string[]): boolean {
